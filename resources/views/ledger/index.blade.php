...
<head>
  ...
  <style>
    ...
    .container { max-width: 1200px; margin: 40px auto; background: #fff; padding: 25px; border-radius: 10px; box-shadow: 0 6px 20px rgba(0,0,0,0.1); }
...
<div class="container">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    {{-- <a href="{{ route('ledger.create') }}" class="btn btn-info">+ Add Entry</a> --}}
  </div>
