...
<head>
<meta charset="UTF-8">
<title>Create Raw Material Issue</title>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
<style>
body { font-family: Arial; background:#f5f7fa; }
.container { max-width: 950px; margin: 50px auto; background: white; padding: 30px; border-radius: 12px; box-shadow: 0 6px 25px rgba(0,0,0,0.15);}
.row-material { display: flex; gap: 10px; margin-bottom: 10px; align-items: center; background:#f9f9f9; padding:5px 10px; border-radius:6px; }
...
.material-stock { font-size: 0.9em; color:#555; }
</style>
</head>
<body>
<div class="container">
    ...
    <form action="{{ route('raw_materials.issue.store') }}" method="POST">
        ...
        <div class="d-flex gap-2 mb-3 mt-3">
            ...
            <button type="button" class="btn btn-secondary" onclick="window.location.href='/raw-material'">Back</button>
        </div>
    </form>
</div>
<script>
